...
$sql = 'INSERT INTO Transfer_table(id, image, dogName, dogAge, sex, con_cas, firaria, dogBreed, sick, personality, transfer, created_at, updated_at) VALUES(NULL, :image, :dogName, :dogAge, :sex, :con_cas, :firaria, :dogBreed, :sick, :personality, :transfer, sysdate(), sysdate())';
